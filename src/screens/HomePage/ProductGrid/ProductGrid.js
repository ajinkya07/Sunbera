...
class ProductGrid extends Component {
  ...
  gridView = item => {
    ...
    const { isSelectPressed, selectedItem } = this.state;
        ...
        <View
          ...
          <View style={gridItemDesign}>
            <TouchableOpacity
              ...
              onPress={() =>
                isSelectPressed
                  ? item.quantity > 0 ? this.showAlreadyToast() : this.selectProduct(item, item.product_inventory_id)
        ...
        {data ? (
          <View style={{ marginLeft: 10 }}>
            <MultiSlider
              ...
              step={1}
              selectedStyle={{ backgroundColor: color.black }}
